...
class JobControllerTest extends WebTestCase
{
    ...
    public function testIndex()
    {
        ...
        $this->assertEquals('Ens\SylvainDavenelBundle\Controller\JobController::indexAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $this->assertEquals('Ens\SylvainDavenelBundle\Controller\JobController::showAction', $client->getRequest()->attributes->get('_controller'));
    ...
    public function getJobByPosition($position)
    {
        ...
        $query = $em->createQuery('SELECT j from EnsSylvainDavenelBundle:Job j WHERE j.position = :position');
    ...
    public function testPublishJob()
    {
        ...
        $query = $em->createQuery('SELECT count(j.id) from EnsSylvainDavenelBundle:Job j WHERE j.position = :position AND j.isActivated = 1');
    ...
    public function testDeleteJob()
    {
        ...
        $query = $em->createQuery('SELECT count(j.id) from EnsSylvainDavenelBundle:Job j WHERE j.position = :position');
    ...
    public function testExtendJob()
    {
        ...
        $kernel->boot();
        $em = $kernel->getContainer()->get('doctrine.orm.entity_manager');
        $job = $em->getRepository('EnsSylvainDavenelBundle:Job')->findOneByPosition('FOO5');
